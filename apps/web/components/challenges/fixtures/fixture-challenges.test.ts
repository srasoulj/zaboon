 ...
 * builds for the frozen fixture lessons u01-l1 (8 course types) and u01-l2 (5 letter types).
...
import recorded from './fixture-challenges.json'
...
function build(): Challenge[] {
  ...
  return [...lesson('u01-l1'), ...lesson('u01-l2')]
}
