 ...
 * linking its issue: it turns red when the fix lands, and then becomes a plain `it`.
 */
...
describe('leagues', () => {
  // https://github.com/srasoulj/zaboon/issues/54
  it.fails(
    "a deleted member's seat is taken by the next learner (fullest open cohort)",
    async () => {
